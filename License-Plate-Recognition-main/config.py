...
# Zone Locator Camera
# =====================
ZONE_MAX_DETECTIONS_PER_FRAME = 10
ZONE_MAX_OCR_PLATES_PER_FRAME = 10
ZONE_SCAN_WINDOW_SECONDS = 60
ZONE_SCAN_PAUSE_SECONDS = 180
ZONE_DETECTION_COOLDOWN_SECONDS = 45
ZONE_PLATE_BUFFER_SIZE = 7
ZONE_PLATE_VOTE_MIN_OCCURRENCES = 5
ZONE_FULL_FRAME_JPEG_QUALITY = 65
ZONE_CROP_JPEG_QUALITY = 85
...
PLATE_VOTE_MIN_OCCURRENCES = 3     # 5/7
PLATE_VOTE_MIN_RATIO = (3.0 / 5.0)  # giữ để tương thích
